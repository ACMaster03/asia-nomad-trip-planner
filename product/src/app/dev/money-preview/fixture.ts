...
export function fixtureTrip(today: string): Trip {
  ...
  const ledger: LedgerEntry[] = [
    ...
    e('s3e', '2026-09-03', 'shopping', 239, 'THB', 'Phone strap'),
    e('s4a', '2026-09-04', 'shopping', 20, 'THB', 'Postcard from the grand palace'),
    ...
    e('s5e', '2026-09-05', 'shopping', 200, 'THB', 'Sunglasses'),
