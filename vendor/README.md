...
| `earth-night.jpg` | Globe texture — night (city lights) | — | https://unpkg.com/three-globe/example/img/earth-night.jpg |
| `earth-day.jpg` | Globe texture — day (blue marble) | — | https://unpkg.com/three-globe/example/img/earth-blue-marble.jpg |
| `countries.geojson` | Country borders (Natural Earth 110m, geometry only — slimmed) | ne_110m | https://github.com/vasturiano/globe.gl `example/datasets/` |
