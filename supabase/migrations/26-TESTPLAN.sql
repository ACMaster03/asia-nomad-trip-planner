...
do $$
begin
  perform pg_temp.be('22222222-2222-2222-2222-222222222222', 'member@test.local');
...
begin
  perform pg_temp.be('11111111-1111-1111-1111-111111111111', 'owner@test.local');
  delete from public.trips where id = 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa';
...
begin
  ...
  values ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'x@test.local', 'viewer',
  ...
  values ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'owner@test.local', 'editor',
