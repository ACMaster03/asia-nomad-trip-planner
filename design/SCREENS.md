...
| 8 | `08-explore.html` | Explore / knowledge base | ☑ **searching (Tier 2 server RPC)** · ☑ **no results** · ☑ **offline / online-required** · ☐ start-empty + country filter · ☐ country selected (cards, own-notes badges) · ☐ city detail · ☐ admin state (add city/field, edit values) |
